...
class TasksTVC: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, moveRowAt sourceIndexPath: IndexPath, to destinationIndexPath: IndexPath) {
        ...
        let sourceTask = sourceIndexPath.section == 0 ? notCompletedTasks[sourceIndexPath.row] : completedTasks[sourceIndexPath.row]
        StorageManager.makeDoneTask(task: sourceTask)
    ...
    @objc private func editBarButtonSystemItemSelector() {
